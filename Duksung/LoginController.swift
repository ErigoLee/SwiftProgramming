        ...
        AF.request(encodedUrlString).responseString(encoding: .utf8) { response in
            ...
            case .success(var str):
                ...
                if str.contains("0") || str.contains("-1") {
                    ...
                    let movieRankController = storyBoard.instantiateViewController(withIdentifier: "Movie") as! MovieRankController
                    self.navigationController?.pushViewController(movieRankController, animated: true)
                }
